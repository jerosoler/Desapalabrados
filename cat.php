<? require('conex.php');
$fraseheader='Cansat de pensar!!!';
$idioma='Català';
$pag='cat.php';
$textobuscar='Cerca';
$textobuscadas='Lletres buscades: ';
$placeholder="Introdueix Lletres";
//BD
$tabla='catalan';
$columna='palabra';
//BD
$bandera='cat.png';
//METAS
 $titulopagina= "Desapalabrados - guanya al Apalabrados fent trampas - En Catalá";
 $metadescripcion ="Busca todas las palabras que puedes formar con tus letras de apalabrados en Español";
 $metakeys = "Desapalabrados, apalabadros, trampas, trampos, trampas apalabrados, trucs, trucs apalabrados, crea paraules, lletres, angry words, paraules crusades, chollo, catala, cat"; // SEPARADO POR COMAS
//METAS
...
} else { echo '<table width="100%"><tr><td align="center"><img src="images/apkandroid.png"></td></tr></table>'; }
